import evolCompose from './evolCompose'


export const returnAll = (...branchs) => (initialParents = {}) =>
  evolCompose(...branchs)(a => a)(initialParents)

export const returnChildren = (...branchs) => (initialParents = {}) =>
  evolCompose(...branchs)(
    allObjects => omit(keys(initialParents), allObjects)
  )(initialParents)

export const returnValueTop = (...branchs) => (initialParents = {}) => {
  var nameTop = branchs[0][0]
  return evolCompose(...branchs)(
    allObjects => allObjects[nameTop]
  )(initialParents)
}
export const curryTopWithFxs = (top, ...otherFxs) => (initData) => {
...
export const curryTopWithObject = (top, objOfFxs) => (initData) => {
